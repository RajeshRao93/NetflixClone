...
const Home = () => {
  ...
  const partThree = [
    "https://occ-0-243-299.1.nflxso.net/dnm/api/v5/rendition/412e4119fb212e3ca9f1add558e2e7fed42f8fb4/AAAABRr4YxdaABuAuH_3FmSQZn7BCvLp-UUPsXE9MiYpvFP3CSUHV2zOew5oVqKqqdaOd3tbFVS0Uf67uIs7_eZydlCghg4nK0nMatRpPImABwTOhnNzCLCxdKrua7pPIcPCZqBYTeAO5g.jpg",
    "https://occ-0-243-299.1.nflxso.net/dnm/api/v5/rendition/412e4119fb212e3ca9f1add558e2e7fed42f8fb4/AAAABTyWK1MKaw8GcObtz47R2Tj7wkLJ7qQu9tk6TVpcoyxpzD4B-zZ569bQ5vGrREBL-MWFkGilXUwy7tCDaj2XOGkUB4RsbbFAmp9NgSr6lygMpUGNHSlyfrFbUORsRkrxSIoh_ggOvg.jpg",
  ...
  return (
    <div>
      ...
      <div className="home-container">
        <section id="trendingPartOne">
          <a href="#trendingPartThree" className="navBtn">
            ‹
          </a>
          {partOne.map((src, index) => {
            return (
          ...
          <a href="#trendingPartTwo" className="navBtn">
            ›
          </a>
        </section>

        <section id="trendingPartTwo">
          <a href="#trendingPartOne" className="navBtn">
            ‹
          </a>
          {partTwo.map((src, index) => {
            return (
              <div key={index} className="item">
                <img src={src} />
              </div>
        ...
        <section id="trendingPartThree">
          <a href="#trendingPartTwo" className="navBtn">
            ‹
          </a>
          {partThree.map((src, index) => {
            return (
              <div key={index} className="item">
                <img src={src} />
              </div>
      ...
      <h2 className="heading">New on Netflix</h2>
      <div className="home-container">
        <section id="newPartOne">
          <a href="#newPartThree" className="navBtn">
            ‹
          </a>
          {partTwo.map((src, index) => {
            return (
          ...
          <a href="#newPartTwo" className="navBtn">
            ›
          </a>
        </section>

        <section id="newPartTwo">
          <a href="#newPartOne" className="navBtn">
            ‹
          </a>
          {partOne.map((src, index) => {
            return (
      ...
      <h2 className="heading">Award-winning Quirky</h2>
      <div className="home-container">
        <section id="awardPartOne">
          <a href="#awardPartThree" className="navBtn">
            ‹
          </a>
          {partThree.map((src, index) => {
            return (
          ...
          <a href="#awardPartTwo" className="navBtn">
            ›
          </a>
        </section>

        <section id="awardPartTwo">
          <a href="#awardPartOne" className="navBtn">
            ‹
          </a>
          {partTwo.map((src, index) => {
            return (
